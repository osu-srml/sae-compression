...
output_folders = {
    "absorption": "/local/scratch/suchit/COLM/test/eval_results/absorption",
    "autointerp": "/local/scratch/suchit/COLM/test/eval_results/autointerp",
    "core": "/local/scratch/suchit/COLM/test/eval_results/core",
    "scr": "/local/scratch/suchit/COLM/test/eval_results/scr",
    "tpp": "/local/scratch/suchit/COLM/test/eval_results/tpp",
    "sparse_probing": "/local/scratch/suchit/COLM/test/eval_results/sparse_probing",
    "unlearning": "/local/scratch/suchit/COLM/test/eval_results/unlearning",
    "ravel": "/local/scratch/suchit/COLM/test/eval_results/ravel",
}
    ...
    eval_runners = {
        "absorption": (
            lambda: absorption.run_eval(
                ...
                selected_saes,
                device,
                "/local/scratch/suchit/COLM/test/eval_results/absorption",
                force_rerun,
            )
        ),
        "autointerp": (
        ...
        "core": (
            lambda: core.multiple_evals(
                ...
                context_size=128,
                output_folder="/local/scratch/suchit/COLM/test/eval_results/core",
                verbose=True,
                dtype=llm_dtype,
                device=device,
            )
        ...
        "ravel": (
            lambda: ravel.run_eval(
                ...
                selected_saes,
                device,
                "/local/scratch/suchit/COLM/test/eval_results/ravel",
                force_rerun,
            )
        ),
        "scr": (
            lambda: scr_and_tpp.run_eval(
                ...
                selected_saes,
                device,
                "/local/scratch/suchit/COLM/test/eval_results",  # We add scr or tpp depending on perform_scr
                force_rerun,
        ...
        "sparse_probing": (
            lambda: sparse_probing.run_eval(
                ...
                selected_saes,
                device,
                "/local/scratch/suchit/COLM/test/eval_results/sparse_probing",
                force_rerun,
                clean_up_activations=True,
                save_activations=save_activations,
            )
        ...
        "unlearning": (
            lambda: unlearning.run_eval(
                ...
                selected_saes,
                device,
                "/local/scratch/suchit/COLM/test/eval_results/unlearning",
                force_rerun,
            )
        ),
    }
